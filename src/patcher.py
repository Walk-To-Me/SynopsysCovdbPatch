...
PATCH_CONFIG: List[Dict[str, Any]] = [
    ...
    {
        "description": "Patch for libucapi.so (Version U-2023.03-SP1)",
    ...
    {
        "description": "Patch for libucapi.so (Version U-2023.03-SP2)",
        "target": b'\x41\x55\x41\x54\x55\x53\x48\x83\xec\x08\x44\x8b\x25\x57\x06\xe0\x00',
        "replacement": b'\xb8\x01\x00\x00\x00\xc3\x48\x83\xec\x08\x44\x8b\x25\x57\x06\xe0\x00',
    },
    {
        "description": "Patch for libucapi.so (Version U-2023.12-SP1)",
    ...
    {
        "description": "Patch for libucapi.so (Version U-2023.12-SP2)",
    ...
    {
        "description": "Patch for libucapi.so (Version W-2024.09)",
        "target": b'\x55\x48\x89\xe5\x48\x81\xec\x80\x01\x00\x00',
        "replacement": b'\x31\xc0\xc3\xe5\x48\x81\xec\x80\x01\x00\x00',
    },
    {
        "description": "Patch for libucapi.so (Version W-2024.09-SP1)",
        "target": b'\x55\x48\x89\xe5\x48\x81\xec\x80\x01\x00\x00',
        "replacement": b'\x31\xc0\xc3\xe5\x48\x81\xec\x80\x01\x00\x00',
    },
    {
        "description": "Patch for libucapi.so (Version X-2025.06)",
        "target": b'\x55\x48\x89\xe5\x48\x81\xec\x80\x01\x00\x00',
        "replacement": b'\x31\xc0\xc3\xe5\x48\x81\xec\x80\x01\x00\x00',
    },
...
def apply_patch(file_path: str, patch_info: Dict[str, Any]) -> bool:
    ...
    print(f"\n[*] Applying patch: '{patch_info['description']}'")
